    ...
    def has_object_permission(self, request, view, obj) -> bool:
        ...
        if action == "view":
            return (
                ...
                or request.user.has_perm("leave_management.view_leaverequest")
        ...
        if action == "change":
            ...
            return request.user.has_perm(
                "leave_management.change_leaverequest"
            ) or is_tenant_admin_or_owner(request.user)

        # Only admins can delete requests
        if action == "delete":
            return request.user.has_perm(
                "leave_management.delete_leaverequest"
            ) or is_tenant_admin_or_owner(request.user)
...
class IsLeaveManager(permissions.BasePermission):
    ...
    def has_permission(self, request, view) -> bool:
        ...
        return request.user.has_perm(
            "leave_management.change_leaverequest"
        ) or request.user.has_perm("leave_management.change_leavebalance")
