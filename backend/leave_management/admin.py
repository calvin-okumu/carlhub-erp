...
class LeaveRequestAdmin(admin.ModelAdmin):
    list_display = (
        'employee', 'tenant', 'leave_type', 'start_date', 'end_date',
        'days_requested', 'status', 'applied_date', 'approved_by'
    )
    list_filter = ('status', 'leave_type', 'tenant', 'applied_date', 'approved_date')
    search_fields = ('employee__email', 'employee__first_name', 'employee__last_name', 'tenant__name')
    readonly_fields = ('slug', 'days_requested', 'applied_date', 'approved_date', 'created_at', 'updated_at')
...
class LeaveBalanceAdmin(admin.ModelAdmin):
    list_display = (
        'employee', 'tenant', 'leave_type', 'year', 'total_days',
        'used_days', 'remaining_days', 'utilization_percentage'
    )
    list_filter = ('leave_type', 'year', 'tenant')
    search_fields = ('employee__email', 'employee__first_name', 'employee__last_name', 'tenant__name')
    readonly_fields = ('slug', 'remaining_days', 'utilization_percentage', 'created_at', 'updated_at')
...
class LeavePolicyAdmin(admin.ModelAdmin):
    list_display = (
        'tenant', 'leave_type', 'annual_entitlement', 'max_consecutive_days',
        'notice_period_days', 'carry_over_allowed', 'is_active'
    )
