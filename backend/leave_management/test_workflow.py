...
from accounts.models import CustomUser, Tenant, UserTenant, Department
from leave_management.models import LeaveRequest, LeaveBalance, LeavePolicy, LeaveApproval
...
class LeaveApprovalWorkflowAPITests(APITestCase):
    ...
    def test_reject_level_endpoint(self):
        ...
        response = self.client.post(url, {
            'action': 'reject',
            'notes': 'Rejected: insufficient team coverage'
        })
