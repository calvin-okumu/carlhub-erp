...
class UserSpecificAccessControlTests(TestCase):
    ...
    def setUp(self):
        ...
        self.owner = CustomUser.objects.create_user(email="owner@test.com", password="testpass123")
        self.admin = CustomUser.objects.create_user(email="admin@test.com", password="testpass123")
    ...
    def test_unapproved_user_access_restricted(self):
        ...
        unapproved_user = CustomUser.objects.create_user(
            email="unapproved@test.com", password="testpass123"
        )
