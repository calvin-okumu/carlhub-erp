...
class EmployeeDocumentService:
    ...
    @staticmethod
    def get_document(user: User, document_id: int) -> EmployeeDocument | None:
    ...
    @staticmethod
    def create_document(
        user: User, file_data: dict[str, Any], title: str, request=None
    ) -> EmployeeDocument:
    ...
    @staticmethod
    def update_document(
        user: User, document_id: int, update_data: dict[str, Any], request=None
    ) -> EmployeeDocument:
