...
class AuditLogService:
    ...
    def can_view_user_logs(user: User, target_user: User) -> bool:
        ...
        try:
            ...
            if (user_tenant.is_approved and target_tenant.is_approved and
                user_tenant.tenant == target_tenant.tenant):
    ...
    @staticmethod
    def export_audit_logs(user: User, format_type: str = 'csv', 
