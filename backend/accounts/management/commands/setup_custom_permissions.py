    ...
    def handle(self, *args, **options):
        ...
        for tenant in Tenant.objects.all():
            ...
            if created:
                ...
                basic_perms = CustomPermission.objects.filter(
                    codename__in=['view_all_projects']
                )
            ...
            if created:
                ...
                hr_perms = CustomPermission.objects.filter(
                    codename__in=['view_all_leave_requests', 'approve_leave_requests', 'manage_leave_policies']
                )
