...
class UserPermissionViewSet(generics.GenericAPIView):
    ...
    def get(self, request, user_id):
        ...
        for perm_group in target_user_tenant.user.permission_groups.filter(tenant=user_tenant.tenant):
        ...
        return Response({
            ...
            'permission_groups': list(target_user_tenant.user.permission_groups.filter(
                tenant=user_tenant.tenant
            ).values('id', 'name'))
        })
