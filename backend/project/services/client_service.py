...
class ClientService:
    ...
    @staticmethod
    def get_clients_for_user(user_tenant: UserTenant, search: Optional[str] = None, 
                           ordering: Optional[str] = None, status: Optional[str] = None) -> List[Client]:
        """
    ...
    @staticmethod
    def get_client_by_slug(user_tenant: UserTenant, slug: str) -> Optional[Client]:
        """
    ...
    @staticmethod
    @transaction.atomic
    def update_client(user_tenant: UserTenant, slug: str, update_data: Dict[str, Any]) -> Optional[Client]:
        """
    ...
    def delete_client(user_tenant: UserTenant, slug: str) -> bool:
        ...
        if client.projects.exists():
            raise ValidationError("Cannot delete client with associated projects. Please delete the projects first.")
