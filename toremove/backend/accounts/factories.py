...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    username = factory.LazyAttribute(lambda obj: obj.email)  # Set username to email for uniqueness
...
class EmployeeDocumentFactory(factory.django.DjangoModelFactory):
    ...
    file_type = fuzzy.FuzzyChoice(["pdf", "doc", "docx", "txt", "jpg", "png", "xls", "xlsx"])
...
class InvitationFactory(factory.django.DjangoModelFactory):
    ...
    role = fuzzy.FuzzyChoice(["Employee", "Manager", "Project Manager", "Administrator"])
...
class CustomPermissionFactory(factory.django.DjangoModelFactory):
    ...
    category = fuzzy.FuzzyChoice(["project", "leave", "crm", "finance", "admin", "custom"])
    app_label = "accounts"
    is_active = True
    created_by = factory.SubFactory(UserFactory)
