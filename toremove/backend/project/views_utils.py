    ...
    request={
        "application/json": {
            ...
            "properties": {
                "user_id": {
                    "type": "integer",
                    "description": "ID of user to assign/remove admin role",
                },
                "assign_admin": {
                    "type": "boolean",
...
def backup_database_view(request):
    ...
    try:
        ...
        return Response(
            {"error": "Only owners can create database backups"}, status=status.HTTP_403_FORBIDDEN
        )
...
def token_refresh_view(request):
    ...
    try:
        ...
        return Response(
            {"access": access_token, "token_type": "Bearer", "expires_in": 86400},  # 24 hours
            status=status.HTTP_200_OK,
        )
