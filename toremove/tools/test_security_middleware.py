...
from saasCRM.security_middleware import APISecurityMiddleware, SecurityHeadersMiddleware
...
def test_security_headers_middleware():
    ...
    if csp:
        ...
        print("  ? Content-Security-Policy: Not set (may be conditional)")
...
def test_api_security_middleware():
    ...
    api_headers = ["X-API-Version", "X-Content-Type-Options", "X-Request-ID"]
...
def test_content_type_validation():
    ...
    invalid_content_types = ["text/plain", "application/xml", ""]
