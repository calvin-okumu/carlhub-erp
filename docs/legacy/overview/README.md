...
- **Financial Management**: Complete multi-currency invoice and payment processing with client billing
- **Database Backup API**: Secure programmatic database backups (superuser only)
