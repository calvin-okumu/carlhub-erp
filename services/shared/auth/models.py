"""
Shared Authentication Models for Microservices

This module contains shared authentication models that can be used across
all microservices. These models are based on the backend/accounts app models.
"""
...
class UserTenant(models.Model):
    ...
    tenant = models.ForeignKey("shared_auth.Tenant", on_delete=models.CASCADE, db_index=True)
...
class EmployeeDocument(models.Model):
    ...
    class Meta:
        db_table = "shared_employee_documents"
...
class Invitation(models.Model):
    ...
    tenant = models.ForeignKey("shared_auth.Tenant", on_delete=models.CASCADE)
...
class AuditLog(models.Model):
    ...
    tenant = models.ForeignKey("shared_auth.Tenant", on_delete=models.CASCADE, null=True, blank=True)
...
class CustomPermission(models.Model):
    ...
    class Meta:
        db_table = "shared_custom_permissions"
...
class PermissionGroup(models.Model):
    ...
    class Meta:
        db_table = "shared_permission_groups"
