...
SECRET_KEY = 'django-insecure-identity-service-secret-key-2024'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'identity_db'),
...
# Custom authentication backends for JWT and tenant context
